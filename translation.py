...
I Am adcash , Bulk Link Converter Bot. I Can Convert Links Directly From Your Adcash.in Account,

Just Send me Any Post with Other Links. I will Convert Those Links Using Your API and Send them Back To You

1. Go To 👉 https://Adcash.in/member/tools/api
...
If You Want Any **Other Shortner** Link Converter Bot Instead Of Adcash.in than **contact** at 👉 @J_shree_ram (all **shortners** support available.)
''' % BASE_SITE
...
START_MESSAGE_REPLY_MARKUP = InlineKeyboardMarkup([[InlineKeyboardButton('ᴄᴏɴɴᴇᴄᴛ Adcash ᴀᴘɪ ↗️', url=f'https://{BASE_SITE}/member/tools/api')]])
