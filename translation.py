...
I Am %s , Bulk Link Converter Bot. I Can Convert Links Directly From Your Uvlink.net Account,

Just Send me Any Post with Other Links. I will Convert Those Links Using Your API and Send them Back To You

1. Go To 👉 https://Uvlink.net/member/tools/api
...
If You Want Any **Other Shortner** Link Converter Bot Instead Of Uvlink.net than **contact** at 👉 @J_shree_ram (all **shortners** support available.)
''' % BASE_SITE
...
START_MESSAGE_REPLY_MARKUP = InlineKeyboardMarkup([[InlineKeyboardButton('ᴄᴏɴɴᴇᴄᴛ ᴜᴠʟɪɴᴋ ᴀᴘɪ ↗️', url=f'https://{BASE_SITE}/member/tools/api')]])
