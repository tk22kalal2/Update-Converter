...
BOT_TOKEN = os.environ.get("BOT_TOKEN", '6917546059:AAF1v5BRgaUYtiTUEHmsNu4wKCXfZKaeHHg')
...
DATABASE_NAME = os.environ.get("DATABASE_NAME", "uvlink")
DATABASE_URL = os.environ.get("DATABASE_URL", "mongodb+srv://singhsawan880:lauda@cluster0.pd6f8s7.mongodb.net/?retryWrites=true&w=majority")
# Optionnal variables
