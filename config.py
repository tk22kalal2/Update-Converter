...
BOT_TOKEN = os.environ.get("BOT_TOKEN", '7160879758:AAEzcDRDNyv9PipRNz2TfcD3m6R0QTuO8i8')
...
DATABASE_NAME = os.environ.get("DATABASE_NAME", "urlink")
DATABASE_URL = os.environ.get("DATABASE_URL", "mongodb+srv://File:store@cluster0.5jhdghw.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
# Optionnal variables
